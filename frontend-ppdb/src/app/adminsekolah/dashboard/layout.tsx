...
const menuItems = [
  ...
  { label: "Pendaftar", href: "/admin/pendaftar", icon: "📋" },
  { label: "Verifikasi", href: "/admin/verifikasi", icon: "✅" },
  { label: "Statistik", href: "/admin/statistik", icon: "📊" },
];
      ...
      <nav className="w-full bg-blue-700 text-white px-6 py-3 flex items-center justify-between shadow-md fixed top-0 left-0 right-0 z-50">
        ...
        <div className="flex items-center gap-3">
          <div className="hidden sm:flex flex-col items-end leading-tight">
            ...
            <span className="text-blue-200 text-xs">SMP Negeri 3 Bandar Lampung</span>
          </div>
